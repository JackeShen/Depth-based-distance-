...
def main():
    ...
    # 用户需要修改以下路径为自己的文件路径
    user_config = {
        'image_path': r"/Users/oldshen/Desktop/4/原数据/4.jpg",          # 用户的图像文件
        'annotation_path': r"/Users/oldshen/Desktop/4/原数据/4.txt", # YOLO格式的txt标注
        'segmentation_path': r"/Users/oldshen/Desktop/4/原数据/4.json", # JSON格式的分割标注
        'depth_map_path': r'/Users/oldshen/PycharmProjects/deepanything/Marigold-main/output/in-the-wild_example/depth_npy/4_depth.npy',  # 如果有现成的深度图，可以提供路径
        ...
        'max_all_points': 10000,  # 最大显示点云数量（可选，默认10000）
